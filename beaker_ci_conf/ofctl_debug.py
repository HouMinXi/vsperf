...
class OFBridge(OFBase):
    ...
    def dump_flows(self):
        ...
        self.run_appctl(['dpif-netdev/pmd-rxq-show'])
        self.run_appctl(['dpif-netdev/pmd-stats-show'])
        #cmd=['sudo', '/usr/bin/ovs-appctl','dpif-netdev/pmd-stats-show']
        #tasks.run_task(cmd,self.logger,'Running ovs-appctl pmd...')
        run_shell('ovs-appctl dpif-netdev/pmd-stats-show >> /tmp/pmd.log')

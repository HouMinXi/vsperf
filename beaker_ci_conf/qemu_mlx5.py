...
class IVnfQemu(IVnf):
    ...
    def _configure_testpmd(self):
        ...
        self.execute_and_wait('/usr/share/dpdk/usertools/dpdk-devbind.py -b mlx5_core ' + pci_list1[0])
        self.execute_and_wait('/usr/share/dpdk/usertools/dpdk-devbind.py -b mlx5_core ' + pci_list1[1])
    ...
    def _bind_dpdk_driver(self, driver, pci_slots):
        ...
        if driver == 'uio_pci_generic':
            ...
            self.execute_and_wait('/usr/share/dpdk/usertools/dpdk-devbind.py -b vfio-pci ' +
                                  pci_slots)

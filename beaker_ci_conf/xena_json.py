...
class XenaJSON(object):
    ...
    def enable_latency_test(self):
        """
        Enable the rfc2544 back to back test
        :return: None
        """
        self.json_data['TestOptions']['TestTypeOptionMap']['Latency'][
            'Enabled'] = 'true'
    ...
    def modify_latency_options(self, start_value, end_value,
                               step_value):
        """
        modify_latency_options
        """
        self.json_data['TestOptions']['TestTypeOptionMap']['Latency'][
            'RateSweepOptions']['StartValue'] = start_value
        self.json_data['TestOptions']['TestTypeOptionMap']['Latency'][
            'RateSweepOptions']['EndValue'] = end_value
        self.json_data['TestOptions']['TestTypeOptionMap']['Latency'][
            'RateSweepOptions']['StepValue'] = step_value
    ...
    def set_test_options_latency(self, packet_sizes, duration, iterations,
                             loss_rate, micro_tpld=False):
        """
        Set the tput test options
        :param packet_sizes: List of packet sizes to test, single int entry is
